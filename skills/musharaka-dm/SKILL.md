...
name: musharaka-dm
description: >
  Activate for: diminishing musharakah, DM, musharaka mutanaqisah,
  co-ownership finance, Islamic home finance, declining musharaka,
  bank equity share, FAS 4, diminishing musharakah schedule,
  rental on bank share, equity buy-out, Islamic mortgage, ghar ka qarz,
  home financing Pakistan, Meezan home finance.
metadata:
  version: "1.0"
...
# Diminishing Musharakah (Musharaka-DM) Skill

## GOVERNING FRAMEWORK

Every Diminishing Musharakah response MUST begin with:
```
...
Pakistan: "Profit from Diminishing Musharakah" (SBP label)
...
| Aspect | AAOIFI FAS 4 | IFRS 9 |
|---|---|---|
| Income recognition | Linear decline with ownership | Front-loaded via EIR |
| Asset classification | Musharaka Investment | Financial Asset at Amortised Cost |
| Income label | Musharaka Rental Income | Profit from Islamic Home Finance |
| Impairment | AAOIFI FAS 30 | IFRS 9 ECL |
| Jurisdictions | Bahrain, Qatar | Pakistan, UAE, Saudi, Malaysia, UK |

---

## When to Use This Skill

- Home financing / property purchase → Diminishing Musharakah ✅
- Customer asks about DM schedule, monthly payment, rental + buy-out
- User mentions "diminishing musharakah", "DM", "musharaka mutanaqisah"
- User asks about Islamic home finance, ghar ka qarz
- Meezan Bank home finance, Dubai Islamic home finance queries
